...
select count(last_name) total, last_name from employee group by last_name order by total desc;

--epilouge
select first_name, last_name from employee where emp_no = 499942;
